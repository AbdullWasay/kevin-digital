(function () {
  ...
  var strings = {
    de: {
      ...
      "a11y.playVideo": "Video abspielen",
      "a11y.enterFullscreen": "Vollbild",
      "a11y.exitFullscreen": "Vollbild beenden",
      "video.fallback": "Video konnte nicht geladen werden.",
      "video.openExternal": "Video in Google Drive öffnen",
      "video.mobileHint": "Tippe auf Play — Video öffnet sich mit allen Steuerungen.",
      "lang.de": "Deutsch",
      "lang.en": "Englisch",
      "nav.about": "ÜBER MICH",
      ...
      "footer.rights": "© 2026 Kevin Digital.net. Alle Rechte vorbehalten.",
      "legal.backHome": "Zurück zur Startseite",
      "meta.privacy.title": "Datenschutzerklärung — Kevin Digital",
      "meta.privacy.description": "Datenschutzerklärung von Kevin Digital.",
      "meta.imprint.title": "Impressum — Kevin Digital",
      "meta.imprint.description": "Impressum und Kontaktinformationen von Kevin Digital.",
    ...
    en: {
      "meta.title": "Kevin Digital — Social Media Manager & YouTube SEO",
      "meta.description":
        "Social media manager and YouTube SEO specialist for businesses and creators focused on reach and sustainable growth.",
      "meta.locale": "en_US",
      ...
      "a11y.enterFullscreen": "Enter fullscreen",
      "a11y.exitFullscreen": "Exit fullscreen",
      "video.fallback": "Video could not be loaded.",
      "video.openExternal": "Open video in Google Drive",
      "video.mobileHint": "Tap play — video opens with full controls.",
      "lang.de": "German",
      "lang.en": "English",
      "nav.about": "ABOUT ME",
      ...
      "s1.l4": "Reach and engagement strategies",
      "s1.l5": "Analytics and performance tracking",
      "s1.goal":
        "Turning social platforms into reliable growth channels that continuously generate attention and engagement.",
      "s2.title": "YouTube SEO and channel growth",
      "s2.intro":
      ...
      "s2.goal": "Building YouTube channels that generate consistent traffic and permanent reach.",
      ...
      "case1.l3": "Structured and consistent posting plan",
      ...
      "footer.rights": "© 2026 Kevin Digital.net. All rights reserved.",
      "legal.backHome": "Back to home",
      "meta.privacy.title": "Privacy Policy — Kevin Digital",
      "meta.privacy.description": "Privacy policy for Kevin Digital.",
      "meta.imprint.title": "Imprint — Kevin Digital",
      "meta.imprint.description": "Legal imprint and contact information for Kevin Digital.",
  ...
  function t(key) {
    ...
    return strings.en[key] || strings.de[key] || key;
  }
  ...
  function applyLanguage(lang) {
    ...
    var contentLang = document.querySelector('meta[http-equiv="content-language"]');
    if (contentLang) contentLang.setAttribute("content", currentLang);
